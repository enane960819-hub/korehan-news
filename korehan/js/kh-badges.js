...
var BADGE_DEFS = [
  ...
  { id:'word_50',    cat:'vocab',     tier:'silver',   icon:pxBadge('flower'), name:'Word Sprout',     desc:'Save 50 words',
    check: function(){ return lsGet(K_SAVED,[]).length >= 50; } },
  { id:'word_100',   cat:'vocab',     tier:'silver',   icon:pxBadge('note'), name:'Word Collector',  desc:'Save 100 words',
    check: function(){ return lsGet(K_SAVED,[]).length >= 100; } },
  { id:'word_300',   cat:'vocab',     tier:'gold',     icon:pxBadge('book'), name:'Vocab Tree',      desc:'Save 300 words',
  ...
  { id:'sec_opinion', cat:'sections', tier:'gold', icon:pxBadge('scroll'), name:'Opinion Master',desc:'Read 10 Opinion articles',
  ...
  { id:'days_90',    cat:'milestone', tier:'gold',     icon:pxBadge('clock'), name:'3-Month Runner', desc:'Study for 90 days after signup',
    check: function(){
      var log = lsGet('kh_study_log',{});
  ...
  { id:'time_friday',  cat:'time',    tier:'silver',   icon:pxBadge('star'), name:'Friday Learner',  desc:'Study on Friday night, 4 times',
    check: function(){ return lsGet('kh_friday_night_count',0) >= 4; } },
  { id:'time_weekend', cat:'time',    tier:'gold',     icon:pxBadge('medal'), name:'Weekend Champ',   desc:'Study on weekends, 8 weeks in a row',
  ...
  { id:'cult_pepero',  cat:'cultural',tier:'gold',     icon:pxBadge('gift'), name:'Pepero Day',      desc:'Study on November 11',
    check: function(){ return lsGet('kh_cult_pepero', false); } },
  { id:'cult_valentine',cat:'cultural',tier:'silver',  icon:pxBadge('flower'), name:'Valentine\'s Day', desc:'Study on February 14',
